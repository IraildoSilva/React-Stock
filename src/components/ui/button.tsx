...
const buttonVariants = cva(
  'inline-flex items-center drop-shadow-md justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-gray-300',
  {
    variants: {
      variant: {
        default:
        ...
        destructive:
          'bg-red-500 text-gray-50 shadow-sm hover:bg-red-500/90 dark:text-gray-50 ',
        outline:
